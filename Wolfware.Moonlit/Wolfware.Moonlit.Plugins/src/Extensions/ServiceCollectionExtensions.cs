...
/// </summary>
/// <remarks>
/// This class is designed to simplify the registration of middleware components that implement <see cref="IPipelineMiddleware"/>
...
public static class ServiceCollectionExtensions
{
  ...
  /// </summary>
  /// <typeparam name="TMiddleware">The type of the middleware component to be registered, which must implement <see cref="IPipelineMiddleware"/>.</typeparam>
  ...
  public static IServiceCollection RegisterMiddleware<TMiddleware>(this IServiceCollection services, string name)
    where TMiddleware : class, IPipelineMiddleware
  {
    ArgumentNullException.ThrowIfNull(name);
    services.AddKeyedSingleton<IPipelineMiddleware, TMiddleware>(name);
    return services;
  }
}
